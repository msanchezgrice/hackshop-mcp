...
export interface Template {
  ...
  // Estimated setup time in hours: assembly + flash + config. First-time
  // tinkerer pace. Optional because some templates are template-level
...
export const TEMPLATES: Template[] = [
  // ─── DISPLAY / AMBIENT ────────────────────────────────────────────────
  {
    ...
    est_setup_hours_min: 0.5,
    est_setup_hours_max: 1,
    viability: "verified",
    viability_note:
  ...
  // ─── AUDIO ────────────────────────────────────────────────────────────
  {
    ...
    est_setup_hours_min: 0.25,
    est_setup_hours_max: 0.5,
    viability: "verified",
    viability_note:
